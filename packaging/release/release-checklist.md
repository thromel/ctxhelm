...
- [ ] Cursor real-client proof: not claimed for v1.1.10
- [ ] OpenCode real-client proof: not claimed for v1.1.10
...
For v1.1.10, the local archive and Apple Silicon Homebrew tap channels can be
