...
- [ ] Cursor real-client proof: not claimed for v1.1.5
- [ ] OpenCode real-client proof: not claimed for v1.1.5
...
For v1.1.5, the local archive and Apple Silicon Homebrew tap channels can be
