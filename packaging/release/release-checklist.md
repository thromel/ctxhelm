...
- [ ] Cursor real-client proof: not claimed for v1.1.3
- [ ] OpenCode real-client proof: not claimed for v1.1.3
...
For v1.1.3, the local archive channel can be `ready`; Homebrew, crates.io,
