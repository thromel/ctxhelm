...
- [ ] Cursor real-client proof: not claimed for v1.1.9
- [ ] OpenCode real-client proof: not claimed for v1.1.9
...
For v1.1.9, the local archive and Apple Silicon Homebrew tap channels can be
