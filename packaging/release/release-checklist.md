...
- [ ] Cursor real-client proof: not claimed for v2.4.3
- [ ] OpenCode real-client proof: not claimed for v2.4.3
...
For v2.4.3, the local archive, multi-platform archive workflow, published
