...
- [ ] Cursor real-client proof: not claimed for v2.4.6
- [ ] OpenCode real-client proof: not claimed for v2.4.6
...
For v2.4.6, the local archive, multi-platform archive workflow, published
