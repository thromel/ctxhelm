...
- [ ] Cursor real-client proof: not claimed for v1.1.8
- [ ] OpenCode real-client proof: not claimed for v1.1.8
...
For v1.1.8, the local archive and Apple Silicon Homebrew tap channels can be
