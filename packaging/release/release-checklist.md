...
- [ ] Cursor real-client proof: not claimed for v2.4.0
- [ ] OpenCode real-client proof: not claimed for v2.4.0
...
For v2.4.0, the local archive, multi-platform archive workflow, published
