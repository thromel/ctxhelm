...
- [ ] Cursor real-client proof: not claimed for v1.1.6
- [ ] OpenCode real-client proof: not claimed for v1.1.6
...
For v1.1.6, the local archive and Apple Silicon Homebrew tap channels can be
