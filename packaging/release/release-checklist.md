...
- [ ] Cursor real-client proof: not claimed for v2.4.2
- [ ] OpenCode real-client proof: not claimed for v2.4.2
...
For v2.4.2, the local archive, multi-platform archive workflow, published
