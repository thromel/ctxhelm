...
- [ ] Cursor real-client proof: not claimed for v2.4.7
- [ ] OpenCode real-client proof: not claimed for v2.4.7
...
For v2.4.7, the local archive, multi-platform archive workflow, published
