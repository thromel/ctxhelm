...
- [ ] Cursor real-client proof: not claimed for v2.4.1
- [ ] OpenCode real-client proof: not claimed for v2.4.1
...
For v2.4.1, the local archive, multi-platform archive workflow, published
