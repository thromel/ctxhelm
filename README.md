...
- Public `v1.1.11` archive install is current and verified through checksum,
...
non-Homebrew workflows. The v1.1.11 archive is named like
...
The expected version diagnostic is `ctxhelm 1.1.11`. See [docs/release.md](docs/release.md) for release details, source-build fallbacks, and maintainer packaging checks.
