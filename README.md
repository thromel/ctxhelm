...
- Public `v1.1.4` archive install is current and verified through checksum,
...
The expected version diagnostic is `ctxpack 1.1.4`. See [docs/release.md](docs/release.md) for release details, source-build fallbacks, and maintainer packaging checks.
