...
- Public `v2.4.4` archive install is current and verified through checksum,
...
non-Homebrew workflows. The v2.4.4 archive is named like
`ctxhelm-v2.4.4-aarch64-apple-darwin.tar.gz`.
...
The expected version diagnostic is `ctxhelm 2.4.4`. See [docs/release.md](docs/release.md) for release details, source-build fallbacks, and maintainer packaging checks.
