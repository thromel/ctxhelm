...
last_activity: 2026-06-01 -- Phase 132 added a source-free Claude Code workflow eval and passed it with real-client prepare_task/get_pack evidence
progress:
  total_phases: 64
  completed_phases: 64
  total_plans: 7
...
Phase: 132 - Claude Workflow Eval
Plan: 132-claude-workflow-eval
Status: Complete
Last activity: 2026-06-01 -- Phase 132 added `scripts/e2e-claude-workflow.sh`, wired it into the release gate as an optional/required maintainer proof, and passed it against Claude Code `2.1.159` with source-free explicit-repo `prepare_task` and `get_pack` request evidence.
