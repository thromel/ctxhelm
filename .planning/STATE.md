...
Status: Complete
Last activity: 2026-06-01 -- Phase 143 added `scripts/e2e-agent-run.sh`, `ctxhelm eval agent-run`, docs, tests, and a real Claude Code `2.1.159` paired-run proof showing the `ctxhelm-brief` lane preserved target coverage while reducing irrelevant reads from 5 to 2.
