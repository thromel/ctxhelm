...
status: active
last_updated: "2026-06-02T06:55:00Z"
last_activity: 2026-06-02 -- Phase 179 added source-free graph edge profiles to historical eval, keeping the warm clean four-repo proof promoted while exposing graph edge-family candidate, selected, target-hit, and target-miss counts for imports and Python re-export edges
progress:
  total_phases: 94
  completed_phases: 94
  total_plans: 7
...
Plan: 179-graph-edge-profiles
Status: Complete
Last activity: 2026-06-02 -- Phase 179 makes graph contribution measurable by edge family through source-free `graphEdgeProfiles` in historical eval reports. The warm clean four-repo proof at `/tmp/ctxhelm-rd/phase179-graph-edge-profiles-warm-proof.json` promotes with the Phase 178 lexical metrics, and the new graph profile shows VeriSchema `imports` edges produced `101` candidates, `19` selected@10, `28` retrieval targets, `6` target hits@10, and `22` target misses@10 while `python_reexport` produced `8` candidates and no target hits.
