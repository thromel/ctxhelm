...
status: active
last_updated: "2026-06-01T18:01:52Z"
last_activity: 2026-06-01 -- Phase 149 published and verified the current public v1.1.11 archive, Homebrew tap, archive install, and public real-client evidence
progress:
  total_phases: 81
  completed_phases: 81
  total_plans: 7
...
Plan: 149-public-v111-currentness
Status: Complete
Last activity: 2026-06-01 -- Phase 149 published `v1.1.11` at commit `9e23b997c4cf8985767c1194245ab6d44491b19e`, verified public release freshness, public archive install, Homebrew tap install/test, and public real-client smoke. Claude Code `2.1.159` passes explicit-repo `prepare_task` and `get_pack`; Codex CLI `0.44.0` remains a source-free optional skip classified as `stream_disconnected`.
