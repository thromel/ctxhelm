...
status: active
last_updated: "2026-06-02T06:20:00Z"
last_activity: 2026-06-02 -- Phase 178 separated raw all-file lexical trails from explained and unexplained proof trails, keeping the clean four-repo proof promoted while exposing RefactoringMiner's raw validation-file trail as explained rather than a product regression
progress:
  total_phases: 94
  completed_phases: 94
  total_plans: 7
...
Plan: 178-explained-all-file-trails
Status: Complete
Last activity: 2026-06-02 -- Phase 178 makes `releaseGate.lexicalComparison` distinguish raw all-file trails from explained and unexplained trails. The fresh clean four-repo proof at `/tmp/ctxhelm-rd/phase178-clean-fixture-explained-trails.json` promotes with `allFileClaim = mixed`, beat `3`, raw match `0`, raw trail `1`, explained trail `1`, unexplained trail `0`, average File Recall@10 `0.61190045`, average lexical File Recall@10 `0.45709258`, file delta `+0.15480787`, agent-evidence delta `+0.2570628`, and context delta `+0.30652046`.
