...
Make storage compatibility diagnosable by recording schema version, ctxhelm version, ranking/compiler version, and migration history.
...
- Diagnostic messages include `ctxhelm.sqlite3` path information where relevant.
