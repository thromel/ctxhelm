...
must_haves:
  truths:
    - "Generated AGENTS, Cursor, Claude, OpenCode, and Codex guidance directs agents to dynamic ctxhelm calls."
...
Purpose: Phase 4 should make agents call ctxhelm at runtime, not bake stale repository context into rule files.
...
<task type="auto" tdd="true">
  ...
  <done>Adapter tests fail if generated guidance grows into static context dumps or omits dynamic repo-explicit ctxhelm usage.</done>
</task>
