...
must_haves:
  ...
  artifacts:
    - path: "crates/ctxpack/src/main.rs"
      ...
      contains: "no_trace"
    - path: "crates/ctxpack-index/src/traces.rs"
  ...
  key_links:
    - from: "crates/ctxpack/src/main.rs"
      to: "crates/ctxpack-index/src/traces.rs"
...
<task type="auto" tdd="true">
  ...
  <files>crates/ctxpack-index/src/traces.rs, crates/ctxpack/src/main.rs, crates/ctxpack/tests/cli_compat.rs, crates/ctxpack/tests/common/mod.rs</files>
  <read_first>
    - `crates/ctxpack/src/main.rs`
    - `crates/ctxpack-index/src/traces.rs`
    - `crates/ctxpack/tests/cli_compat.rs`
  ...
  <behavior>
    ...
    - DIAG-04: binary CLI tests cover stale-cache diagnostics and constrained `CTXPACK_HOME`.
  </behavior>
  <action>
  ...
  <verify>
    <automated>cargo test -p ctxpack --test cli_compat -- --nocapture</automated>
  </verify>
  <acceptance_criteria>
    ...
    - `cargo run -p ctxpack -- --help` shows any new flag without breaking command listing.
  </acceptance_criteria>
...
<task type="auto" tdd="true">
  ...
  <files>crates/ctxpack-mcp/src/tools.rs, crates/ctxpack-mcp/src/resources.rs, crates/ctxpack-mcp/src/schemas.rs, crates/ctxpack-mcp/src/lib.rs</files>
  <read_first>
    - `crates/ctxpack-mcp/src/tools.rs`
    - `crates/ctxpack-mcp/src/resources.rs`
    - `crates/ctxpack-mcp/src/schemas.rs`
  ...
  <verify>
    <automated>cargo test -p ctxpack-mcp diagnostics -- --nocapture</automated>
    <automated>cargo test -p ctxpack-mcp file_resource -- --nocapture</automated>
    <automated>cargo test -p ctxpack-mcp trace -- --nocapture</automated>
  </verify>
  <acceptance_criteria>
...
<task type="auto">
  ...
  <files>crates/ctxpack-core/src/contracts.rs, crates/ctxpack-index/src/*.rs, crates/ctxpack-compiler/src/*.rs, crates/ctxpack-mcp/src/*.rs, crates/ctxpack/src/main.rs, crates/ctxpack/tests/*.rs</files>
  <read_first>
    - `AGENTS.md`
    - `.planning/phases/02-trust-layer-operational-diagnostics/02-RESEARCH.md`
  ...
  <acceptance_criteria>
    ...
    - `cargo run -p ctxpack -- --help` passes.
...
cargo test -p ctxpack-mcp diagnostics -- --nocapture
cargo test -p ctxpack-mcp file_resource -- --nocapture
cargo test -p ctxpack-mcp trace -- --nocapture
