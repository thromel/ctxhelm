...
- Added source-free semantic provider status contracts and CLI output through `ctxpack semantic status`.
- Added report-only retrieval policy experiment rows through `ctxpack eval policy experiments`.
