...
Latest follow-up: Phase 189 uses the Phase 188 selected-signal profiles to rebalance broad governance docs against source-history reserve. Broad root governance docs now run before broad source-history reserve, and source-history candidates prefer module entrypoints such as `src/lib.rs`. The fresh release-binary proof promotes; ctxhelm File Recall@10 improves from `0.5587302` to `0.67777777`, ctxhelm Source Recall@10 stays `0.55`, and RefactoringMiner/ReAgent/VeriSchema stay unchanged.

**Phases planned:** Phases 61-65 plus Phase 66-189 production-readiness follow-ups, 7 planned phase files plus measured proof follow-up artifacts
