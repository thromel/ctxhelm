...
- Current public `v1.1.4` archive release with verified GitHub asset digests, install proof, product freshness, distribution-readiness proof, and optional real-client evidence.
