...
- Active RepoWinnow product branding with `ctxpack` retained as the stable CLI, package, Homebrew formula, MCP namespace, and local state compatibility surface, and a `v1.1.7` release line ready for archive and Homebrew publication.
