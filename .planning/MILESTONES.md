...
- Current public `v1.1.3` archive release with verified GitHub asset digests, install proof, product freshness, and optional real-client evidence.
- Homebrew formula renderability and crates package boundary checks for deferred install channels, without publishing package-manager artifacts.
