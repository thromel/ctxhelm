...
Make the production lexical comparison match the evidence ctxhelm actually gives
...
`ctxhelm eval proof` now adds agent-evidence fields to
...
- average agent-evidence Recall@10: ctxhelm `0.64502084`, lexical `0.45709258`
- average context Recall@10: ctxhelm `0.64859205`, lexical `0.41836542`

This is the tighter production claim: ctxhelm still does not beat lexical on
...
git diff --check
jq empty .ctxhelm/e2e/phase126-agent-evidence-lexical-comparison.json
```
