...
Publish the ctxhelm branding product change as a current public `ctxhelm`
release, keeping the archive and Homebrew install paths current with `main`.

## Release

- Tag: `v1.1.6`
- URL: `https://github.com/thromel/ctxhelm/releases/tag/v1.1.6`
- Target commit: `d1a602c6fbce9e69c2fd2e80e8e2b98a7a5dc8f6`
- Archive: `ctxhelm-v1.1.6-aarch64-apple-darwin.tar.gz`
...
- Public CI: `https://github.com/thromel/ctxhelm/actions/runs/26749403843`
...
- Formula URL: `https://github.com/thromel/ctxhelm/releases/download/v1.1.6/ctxhelm-v1.1.6-aarch64-apple-darwin.tar.gz`
...
- `.ctxhelm/e2e/phase140-github-release.json`
- `.ctxhelm/e2e/phase140-github-release-verify.json`
- `.ctxhelm/e2e/phase140-public-release-freshness.json`
- `.ctxhelm/e2e/phase140-public-archive-install.json`
- `.ctxhelm/e2e/phase140-homebrew-tap-proof.json`
- `.ctxhelm/e2e/phase140-public-real-client-smoke.json`
...
bash scripts/verify-release-archive.sh \
  --archive dist/ctxhelm-v1.1.6-aarch64-apple-darwin.tar.gz \
  --manifest dist/ctxhelm-v1.1.6-aarch64-apple-darwin.manifest.json \
...
bash scripts/verify-public-archive-install.sh \
  ...
  --expected-version "ctxhelm 1.1.6"
bash scripts/verify-homebrew-tap.sh \
  --tap thromel/tap \
  --formula ctxhelm \
  --expected-version "ctxhelm 1.1.6" \
  --expected-url https://github.com/thromel/ctxhelm/releases/download/v1.1.6/ctxhelm-v1.1.6-aarch64-apple-darwin.tar.gz \
