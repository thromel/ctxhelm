...
1. Semantic is not yet a proven default-lift channel. It is useful and bounded,
   ...
   repos while preserving a smaller clean ctxhelm lift. The right next work is
   deciding whether this narrower route belongs in provider policy as opt-in
