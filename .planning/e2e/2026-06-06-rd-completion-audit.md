...
1. Semantic is not yet a proven default-lift channel. It is useful and bounded,
   ...
   variants and rejects them because both are noisier than corrected Jina. The
...
4. Move semantic R&D from routing existing clean-looking support profiles to a
   ...
   branch after both variants increase candidate misses and semantic noise. The
   next semantic step is
...
both are noisier than corrected Jina. The remaining semantic R&D path is
