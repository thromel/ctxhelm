...
Plans:
- [x] 52-source-free-candidate-feature-export-01-PLAN.md - Create feature export contracts, privacy checks, storage operations, and CLI/report surfaces.
...
Plans:
- [x] 53-paired-baseline-ablation-analysis-01-PLAN.md - Add paired comparison reports, threshold verdicts, signal saturation diagnostics, and lexical-parity flags.
