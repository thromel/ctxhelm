...
pub(crate) fn resources_list_result() -> Value {
    json!({
        "resources": [
            ...
            {
                "uri": "ctxhelm://repo/context-areas",
                "name": "Repository Context Areas",
                "description": "Source-free area inventory for progressive broad-task inspection.",
                "mimeType": "application/json"
            },
            {
                "uri": "ctxhelm://workspace/status",
                "name": "Workspace Status",
                "description": "Source-free local workspace status from .ctxhelm/workspace.json.",
                "mimeType": "application/json"
            },
            {
                "uri": "ctxhelm://workspace/shared-artifacts",
            ...
            {
                "uri": "ctxhelm://pack/guide",
                "name": "Context Pack Guide",
                "description": "How to request task-conditioned context packs with ctxhelm.get_pack.",
