...
fn workspace_repo_confidence(plan: &ctxpack_core::ContextPlan) -> f32 {
...
fn workspace_repo_reason(plan: &ctxpack_core::ContextPlan) -> String {
...
mod tests {
    use super::*;
    use ctxpack_core::{TaskType, WorkspaceManifest, WorkspaceRepo};
    use ctxpack_index::{write_workspace_manifest, WORKSPACE_MANIFEST_SCHEMA_VERSION};
