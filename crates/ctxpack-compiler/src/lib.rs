...
pub use eval::{
    ...
    CandidateFeatureKindDelta, EvalComparison, HistoricalChangedPathLabel, HistoricalCommitEval,
    ...
    ProductProofMetric, ProductProofReport, ProtectedEvidenceSignalSummary,
