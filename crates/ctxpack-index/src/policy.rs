...
use ctxpack_core::{Diagnostic, DiagnosticSeverity, FileRole};
use serde::{Deserialize, Serialize};
use std::fs;
use std::path::Path;

pub const POLICY_VERSION: &str = "ctxpack-policy-v1";
...
pub fn read_safe_source(
        ...
        })
    {
        return Ok(skipped(
            ...
            "Source file was excluded by ctxpack source policy.",
...
mod tests {
    ...
    use ctxpack_core::{DiagnosticSeverity, FileRole};
    use std::fs;
