...
fn workspace_packages_have_release_identity() {
    ...
    for name in expected {
        ...
        assert_eq!(package["version"], "1.1.11", "{name} version");
...
fn version_reports_release_identity() {
    Command::cargo_bin("ctxhelm")
        ...
        .assert()
        .success()
        .stdout(contains("ctxhelm 1.1.11"));
}
...
fn doctor_verifies_binary_manifest_and_local_state_source_free() {
    ...
    fs::write(
        ...
        json!({
            ...
            "auditReport": "ctxhelm-v1.1.11-test.audit.json",
            "privacyStatus": {
                "localOnly": true,
    ...
    assert_eq!(value["binary"]["version"], "ctxhelm 1.1.11");
    assert_eq!(value["releaseManifest"]["version"], "1.1.11");
