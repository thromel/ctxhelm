...
pub use eval::{
    ...
    learned_semantic_policy_cross_repo_report,
    ...
    BenchmarkThresholdCheck, CandidateCoverageAreaSummary, CandidateCoverageSummary,
    CandidateFeatureComparisonReport, CandidateFeatureKindDelta, CandidateMissedFileProfile,
    ContextAreaNextReadSummary, ContextAreaPressurePeak, ContextAreaPressureSummary,
    EvalComparison, GraphEdgeAblationResult, GraphEdgeProfile, HistoricalChangedPathLabel,
    ...
    HistoricalSlowCommitSummary, LearnedSemanticPolicyCrossRepoProfile,
    LearnedSemanticPolicyCrossRepoReport, LearnedSemanticPolicyProfileKeyMode,
    LearnedSemanticPolicyTrainTestReport, LexicalBackendCommitRow, LexicalBackendComparison,
