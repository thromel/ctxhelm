...
pub use eval::{
    ...
    semantic_precision_gate_report_with_provider_and_range, write_candidate_feature_export,
    ...
    HistoricalSlowCommitSummary, LearnedSemanticPolicyTrainTestReport, LexicalBackendCommitRow,
    LexicalBackendComparison, LexicalBackendCorpusOptions, LexicalBackendCorpusReport,
    LexicalBackendMetrics, LexicalBackendRuntimeSummary, MemoryReuseSummary,
    ...
    ProtectedEvidenceSummary, RankingMetrics, RecommendedResearchAction,
