...
fn render_provider_policy(policy: &ctxhelm_core::ProviderPolicyReport) -> String {
...
<head>
  ...
  <title>ctxhelm Pack Inspector</title>
  <style>
...
fn render_signal_badges_from_evidence(evidence: &[ctxhelm_core::RetrievalEvidence]) -> String {
...
fn render_signal_badges_from_scores(scores: &[ctxhelm_core::RetrievalSignalScore]) -> String {
    if scores.is_empty() {
