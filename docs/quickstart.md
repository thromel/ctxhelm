...
For v1.1.6, `ctxpack --version` should print `ctxpack 1.1.6`. If the command is not found, fix your shell or agent `PATH`, or use an absolute binary path in the MCP configuration.
