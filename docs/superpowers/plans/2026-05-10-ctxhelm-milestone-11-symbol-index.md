# ctxhelm Milestone 11: Local Symbol Index
...
- Add typed symbol contracts in `ctxhelm-index`.
...
- Add `ctxhelm symbols` for listing and querying symbols.
- Back `ctxhelm://symbol/<query>` with symbol search instead of plain lexical search.
...
- CLI smoke for `ctxhelm symbols --query`
- MCP stdio smoke for `ctxhelm://symbol/<query>`
