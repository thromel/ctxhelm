...
ctxhelm v1.1.9 ships through public release archives and a public Apple Silicon
...
Current v1.1.9 archives are checksum-audited but not signed installers. Future
...
The v1.1.9 production candidate has these distribution states:
