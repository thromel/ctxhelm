    ...
    cat >"$proof_summary" <<'JSON'
{
  ...
  "releaseArchive": {
    "name": "ctxhelm-v2.4.2-aarch64-apple-darwin.tar.gz",
...
mkdir -p "$assets_dir"
printf 'archive\n' >"$assets_dir/ctxhelm-v2.4.2-test.tar.gz"
printf 'manifest\n' >"$assets_dir/ctxhelm-v2.4.2-test.manifest.json"
...
archive_digest = hashlib.sha256((assets / "ctxhelm-v2.4.2-test.tar.gz").read_bytes()).hexdigest()
manifest_digest = hashlib.sha256((assets / "ctxhelm-v2.4.2-test.manifest.json").read_bytes()).hexdigest()
payload = {
    "assets": [
        {
        ...
        },
        {
            ...
            "name": "ctxhelm-v2.4.2-test.manifest.json",
            "state": "uploaded",
        },
    ],
    "isDraft": False,
    ...
    "url": "https://github.com/thromel/ctxhelm/releases/tag/v2.4.2",
}
...
printf 'artifact placeholder\n' >"$candidate_dir/ctxhelm-v2.4.2-aarch64-apple-darwin.tar.gz"
