    ...
    cat >"$proof_summary" <<'JSON'
{
  ...
  "releaseArchive": {
    "name": "ctxpack-v1.1.4-aarch64-apple-darwin.tar.gz",
...
mkdir -p "$assets_dir"
printf 'archive\n' >"$assets_dir/ctxpack-v1.1.4-test.tar.gz"
printf 'manifest\n' >"$assets_dir/ctxpack-v1.1.4-test.manifest.json"
...
archive_digest = hashlib.sha256((assets / "ctxpack-v1.1.4-test.tar.gz").read_bytes()).hexdigest()
manifest_digest = hashlib.sha256((assets / "ctxpack-v1.1.4-test.manifest.json").read_bytes()).hexdigest()
payload = {
    "assets": [
        {
        ...
        },
        {
            ...
            "name": "ctxpack-v1.1.4-test.manifest.json",
            "state": "uploaded",
        },
    ],
    "isDraft": False,
    ...
    "url": "https://github.com/thromel/ctxpack/releases/tag/v1.1.4",
}
...
printf 'artifact placeholder\n' >"$candidate_dir/ctxpack-v1.1.4-aarch64-apple-darwin.tar.gz"
